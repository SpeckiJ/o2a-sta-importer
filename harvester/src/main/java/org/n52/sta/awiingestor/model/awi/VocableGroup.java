...
import org.n52.sta.awiingestor.model.awi.deserializers.VocableGroupDes;
 ...
 */
@JsonDeserialize(using = VocableGroupDes.class)
public interface VocableGroup {
    ...
    @JsonProperty("name") void setName(String name);
