...
import org.n52.sta.awiingestor.model.awi.EventItemImpl;
...
/**
 * Custom Deserializer for json value `EventItem`. It can either
 *
 * @author <a href="mailto:j.speckamp@52north.org">Jan Speckamp</a>
 */
public class EventItemDes extends JsonDeserializer<EventItem> {

    Map<String, EventItem> cache = new HashMap<>();
